...
def repository_patterns(app_name, model, index=fedoralink.views.GenericIndexView,
                        ...
                        edit_template_name='baseOArepo/edit.html', edit_success_url='index', edit_prefix="", attachment_model =None,
        ...
        url(r'^', include(patterns('',
                                   ...
                                   url(r'^extended_search(?P<parametry>.*)$',
                                       get_view(extended_search, model=model, base_template=search_base_template,
                                                list_item_template=search_list_item_template, facets=search_facets, orderings=search_orderings, default_ordering=search_default_ordering),
                                   ...
                                   #
                                   url('^download/(?P<bitstream_id>[0-9a-z_-]+)$', get_view(download, model = attachment_model), name="download"),
